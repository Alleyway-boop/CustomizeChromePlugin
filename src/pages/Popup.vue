<template>
  <div class="flex flex-col gap-4 w-[380px] p-4 bg-gradient-to-br from-slate-50 to-blue-50/30 min-h-[500px]">
    ...
    <!-- 设置区域 -->
    <div class="p-4 bg-white/60 backdrop-blur-sm rounded-xl shadow-sm border border-white/30">
      <div class="flex items-center gap-2 mb-3">
        <div class="i-carbon-settings text-indigo-500 text-lg"></div>
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center gap-3">
                    <span class="text-xs text-gray-500 flex-shrink-0 font-medium">
                      {{ new Date(item.lastUseTime).toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' })
                      }}
                    </span>
